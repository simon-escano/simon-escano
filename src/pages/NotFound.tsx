        ...
        >
          <div className="p-8 sm:p-12 space-y-6 text-center">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <Link
                to="/projects"
                className="px-5 py-2.5 rounded-full bg-slate-800 hover:bg-slate-700 border border-slate-700 text-xs font-mono text-slate-200 transition-colors flex items-center gap-1.5"
              >
