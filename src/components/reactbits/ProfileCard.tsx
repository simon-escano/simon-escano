...
export const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  behindGlowColor = 'rgba(56, 69, 201, 0.5)',
  behindGlowSize = '50%',
  className = '',
  enableTilt = true,
  ...
  const getOffsets = (evt: React.PointerEvent<HTMLDivElement> | PointerEvent, el: HTMLElement) => {
  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        '--behind-glow-color': behindGlowColor ?? 'rgba(56, 69, 201, 0.5)',
