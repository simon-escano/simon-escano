...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  const handleItemSelect = (item: StaggeredMenuItem, e: React.MouseEvent) => {
    e.preventDefault();
    closeMenu();
    onItemClick?.(item);
  };
  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Mobile navigation toggle">
        <button
          ref={toggleBtnRef}
          className="sm-toggle"
              ...
              items.map((it, idx) => (
                <li className="sm-panel-itemWrap" key={it.label + idx}>
                  <a
                    ...
                    data-index={idx + 1}
                    onClick={(e) => handleItemSelect(it, e)}
                  >
