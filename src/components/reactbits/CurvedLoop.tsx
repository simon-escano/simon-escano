...
export const CurvedLoop: React.FC<CurvedLoopProps> = ({
  ...
  return (
    <div
      className="w-full flex items-center justify-center overflow-hidden select-none py-6"
    ...
    >
      <svg className="w-full h-auto overflow-visible select-none" viewBox="0 0 1440 100">
